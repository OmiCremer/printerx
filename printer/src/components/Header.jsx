...
import printerx from "../assets/img/printerxLogo.png";
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="me-auto">
              ...
              <NavDropdown title="Productos" id="basic-nav-dropdown">
                <NavDropdown.Item onClick={sublimacion}>
                  Sublimacion
                </NavDropdown.Item>
                <NavDropdown.Item onClick={equiposUV}>
                  Equipos UV
                </NavDropdown.Item>
                <NavDropdown.Item onClick={calandras}>
                  Calandras
                </NavDropdown.Item>
              </NavDropdown>
